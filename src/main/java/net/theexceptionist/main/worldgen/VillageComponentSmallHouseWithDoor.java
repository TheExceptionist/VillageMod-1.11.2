...
public class VillageComponentSmallHouseWithDoor  extends StructureVillagePieces.Village
{
    private boolean isRoofAccessible;

    public VillageComponentSmallHouseWithDoor()
    {
    }

    public VillageComponentSmallHouseWithDoor(StructureVillagePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
    {
    ...
    public static VillageComponentSmallHouseWithDoor createPiece(StructureVillagePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
    {
        ...
        return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new VillageComponentSmallHouseWithDoor(start, p_175858_7_, rand, structureboundingbox, facing);
    }
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
    {
     ...
     //   System.out.println("Working");
        ...
        this.createVillageDoor(worldIn, structureBoundingBoxIn,randomIn, 2, 1, 0, EnumFacing.SOUTH);
