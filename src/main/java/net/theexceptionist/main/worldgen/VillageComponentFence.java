...
public class VillageComponentFence extends StructureVillagePieces.Village
{
    ...
    public VillageComponentFence()
    {
    }

    public VillageComponentFence(StructureVillagePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
    {
