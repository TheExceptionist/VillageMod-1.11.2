...
public class EntityVillagerSoldier extends EntityVillager{
	...
	protected int type;
	protected String title = "Soldier";
	protected String[] names = {"Merek",
			"Carac",
			"Ulric",
			"Tybalt",
			"Borin",
	...
	public EntityVillagerSoldier(World worldIn, boolean type) {
		super(worldIn);
	...
	protected String getRandomName(){
		return names[this.world.rand.nextInt(names.length)];
	};
	
	public EntityVillagerSoldier(World worldIn, int type) {
		super(worldIn);
		this.type = type;
	...
	public void initBackground(){
		if(type == 0 && title == "Soldier"){
			this.title = "Footman - "+this.getRandomName();
		}else if(type == 1 && title == "Soldier"){
			this.title = "Peasant - "+this.getRandomName();
		}else if(type == 2 && title == "Soldier"){
			this.title = "Militia - "+this.getRandomName();
		}else if(type == 3 && title == "Soldier"){
			this.title = "Mercenary - "+this.getRandomName();
		}else if(type == 4 && title == "Soldier"){
			this.title = "Villager-At-Arms - "+this.getRandomName();
		}
		this.setCustomNameTag(title);
	}
