...
public class EntityVillagerSoldierWandering extends EntityVillager{
	private int attack = 4, armor = 0;
	...
	protected String title = "Enforcer";
	protected boolean attackAnimals = false;
	...
	public EntityVillagerSoldierWandering(World worldIn) {
		super(worldIn);
		this.title = "Enforcer - "+this.getRandomName();
		this.setCustomNameTag(title);
		//System.out.println("Working");
	}
	
	public EntityVillagerSoldierWandering(World worldIn, boolean attackAnimals) {
		super(worldIn);
		this.attackAnimals = attackAnimals;
		this.title = "Enforcer - "+this.getRandomName();
		this.setCustomNameTag(title);
		//System.out.println("Working");
	}
