...
import net.theexceptionist.main.Ref;
	...
	public class RenderVillagerAlchemist extends RenderLiving<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Ref.MODID,"textures/entity/villager/alchemist.png");
		
	    public RenderVillagerAlchemist(RenderManager renderManagerIn)
	    {
