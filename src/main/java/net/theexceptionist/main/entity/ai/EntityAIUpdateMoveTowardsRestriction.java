...
public class EntityAIUpdateMoveTowardsRestriction  extends EntityAIBase
{
    ...
    public EntityAIUpdateMoveTowardsRestriction(EntityCreature creatureIn, double speedIn)
    {
    ...
    {
        if (theEntity.getHomePosition().distanceSq(new BlockPos(this.theEntity.posX, this.theEntity.posY,this.theEntity.posZ)) < (double)(theEntity.getMaximumHomeDistance() * theEntity.getMaximumHomeDistance()) * 2)
        {
            return false;
        }
        else
