...
public class EntityVillagerGuardian extends EntityVillagerSoldier{
	private int attack = 2, armor = 2;
	...
	private World world;
	private EntityVillagerMage master;
	 ...
	 protected void applyEntityAttributes()
	    {
	        ...
	        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.35D);
        	this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(20.0D);
        	//this.getEntityAttribute(SharedMonsterAttributes.F)
	        this.setProfession(1);
...
//	        this.startRiding(horse);
	...
	public void setMaster(EntityVillagerMage entityVillagerMage) {
		this.master = entityVillagerMage;
		
	}
	
	public EntityVillagerMage getMaster() {
