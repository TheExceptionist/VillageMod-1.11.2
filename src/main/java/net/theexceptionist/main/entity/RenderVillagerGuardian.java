...
import net.theexceptionist.main.Ref;
	...
	{
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Ref.MODID,"textures/entity/villager/guardian.png");
		
		public RenderVillagerGuardian(RenderManager renderManagerIn)
	    {
